> ⚠️ This forked from https://github.com/awslabs/aws-cloudformation-templates to demo how one can use SonarQube to scan CloudFormation templates. The original README.md is below.
